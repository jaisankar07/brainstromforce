  ...
  <section id="slider">
    <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="<?php echo esc_attr(get_theme_mod('it_company_slider_speed',3000)); ?>"> 
          ...
          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
            <a href="<?php echo esc_url( get_permalink() );?>">
              <?php if(has_post_thumbnail()){
                ...
                <img src="<?php echo esc_url(get_theme_file_uri()); ?>/block-patterns/images/banner.png" alt="" />
              <?php } ?>
            ...
            <div class="carousel-caption py-md-3 py-0">
              <div class="inner_carousel">                
                <?php if ( get_theme_mod('it_company_slider_content',true) != '' ) {?>
                  <p><?php $it_services_excerpt = get_the_excerpt(); echo esc_html( it_company_string_limit_words( $it_services_excerpt, esc_attr(get_theme_mod('it_company_slider_excerpt_number','25')))); ?></p>
                <?php }?>
                <?php if ( get_theme_mod('it_company_slider_title',true) != '' ) {?>
                  <h1 class="animated fadeInDown p-0"><?php the_title(); ?></h1>
                <?php }?>
                <?php if(get_theme_mod('it_services_slider_button_label',true) != '' || get_theme_mod('it_company_slider_button_responsive',true) != '') {?>
                  <?php if ( get_theme_mod('it_services_slider_button_label','READ MORE') != '' ) {?>
                    <div class="more-btn py-md-3 py-0">
                      <a href="<?php the_permalink(); ?>"><?php echo esc_html( get_theme_mod('it_services_slider_button_label',__('READ MORE','it-services')) ); ?><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('it_services_slider_button_label',__('READ MORE','it-services')) ); ?></span></a>
                    </div>
                  <?php }?>
                <?php }?>
              </div>
      ...
      <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-bs-slide="prev">
        ...
        <span class="screen-reader-text"><?php esc_html_e('Previous','it-services'); ?></span>
      </a>
      <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-bs-slide="next">
        <span class="carousel-control-next-icon py-2 px-3" aria-hidden="true"><i class="fas fa-chevron-right"></i></span>
        <span class="screen-reader-text"><?php esc_html_e('Next','it-services'); ?></span>
      </a>
    </div>
