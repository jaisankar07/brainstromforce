            ...
            <div class="carousel-caption py-md-3 py-0">
              <div class="inner_carousel">                
                ...
                <?php if(get_theme_mod('it_company_slider_button',true) != '' || get_theme_mod('it_company_slider_button_responsive',true) != '') {?>
                  <?php if ( get_theme_mod('it_company_slider_button_label','READ MORE') != '' ) {?>
                    <div class="more-btn py-md-3 py-0">
                      <a href="<?php the_permalink(); ?>"><?php echo esc_html( get_theme_mod('it_company_slider_button_label',__('READ MORE','it-services')) ); ?><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('it_company_slider_button_label',__('READ MORE','it-services')) ); ?></span></a>
                    </div>
                  <?php }?>
                <?php }?>
              </div>
