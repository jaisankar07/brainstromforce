...
function it_services_enqueue_customizer_css() {
	wp_enqueue_style( 'it_services-customizer-css', get_stylesheet_directory_uri() . '/css/customize-controls.css' );
	}
	add_action( 'customize_controls_print_styles', 'it_services_enqueue_customizer_css' );
...
function it_services_customize_register() {     
	...
	$wp_customize->add_control('it_services_slider_button_label',array(
		'label'	=> __('Slider Button Label','it-services'),
