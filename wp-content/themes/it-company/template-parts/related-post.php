				...
				<div class="col-lg-4 col-md-4">
					<article class="blog-sec p-2 mb-4">
					    ...
					    <?php if(get_the_excerpt()) { ?>
					      <div class="entry-content m-0"><p class="m-0"><?php $it_company_excerpt = get_the_excerpt(); echo esc_html( it_company_string_limit_words( $it_company_excerpt, esc_attr(get_theme_mod('it_company_related_post_excerpt_number','20')))); ?> <?php echo esc_html( get_theme_mod('it_company_button_excerpt_suffix','...') ); ?></p></div>
					    <?php }?>
