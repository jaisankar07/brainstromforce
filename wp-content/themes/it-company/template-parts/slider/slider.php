            ...
            <div class="carousel-caption py-md-3 py-0">
              <div class="inner_carousel">
                ...
                <?php if ( get_theme_mod('it_company_slider_content',true) != '' ) {?>
                  <p><?php $it_company_excerpt = get_the_excerpt(); echo esc_html( it_company_string_limit_words( $it_company_excerpt, esc_attr(get_theme_mod('it_company_slider_excerpt_number','25')))); ?></p>
                <?php }?>
