...
<main id="maincontent" role="main">
    <?php while ( have_posts() ) : the_post(); ?>
        ...
        <div class="container">
            <?php $it_company_page_layout = get_theme_mod( 'it_company_single_page_layout','One Column');
            if($it_company_page_layout == 'One Column'){ ?>
                <div id="wrapper">
                    <div class="main-wrap-box py-4"> 
                        <?php if(get_theme_mod('it_company_single_page_breadcrumb',true) != ''){ ?>
            ...
            <?php }else if($it_company_page_layout == 'Left Sidebar'){ ?>
                <div class="row">
            ...
            <?php }else if($it_company_page_layout == 'Right Sidebar'){ ?>
                <div class="row">
                    <div class="col-lg-9 col-md-8">
                        <div id="wrapper">
                            <div class="main-wrap-box py-4"> 
