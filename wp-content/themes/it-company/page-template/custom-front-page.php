                ...
                <div class="right-part mb-4 text-md-start text-center">
                  <div class="row m-0"> 
                    ...
                    <div class="col-lg-9 col-md-9 p-0">
                      ...
                      <p class="mb-md-3 mb-1 text-md-start text-center"><?php $it_company_excerpt = get_the_excerpt(); echo esc_html( it_company_string_limit_words( $it_company_excerpt, esc_attr(get_theme_mod('it_company_about_excerpt_number','10')))); ?></p>
