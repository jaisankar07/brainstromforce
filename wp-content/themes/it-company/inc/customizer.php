...
function it_company_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('it_company_menu_padding',array(
		'default'=> 20,
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new IT_Company_WP_Customize_Range_Control( $wp_customize,'it_company_menu_padding',array(
		'label'	=> __('Menu Font Padding','it-company'),
		'section'=> 'it_company_header_section',
		'input_attrs' => array(
         'step'  => 1,
			'min'   => 0,
	...
	$wp_customize->add_setting('it_company_menu_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'it_company_menu_color', array(
		'label'    => __('Menu Color', 'it-company'),
		'section'  => 'it_company_header_section',
		'settings' => 'it_company_menu_color',
	)));

	$wp_customize->add_setting('it_company_menu_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'it_company_menu_hover_color', array(
		'label'    => __('Menu Hover Color', 'it-company'),
		'section'  => 'it_company_header_section',
		'settings' => 'it_company_menu_hover_color',
	)));

	$wp_customize->add_setting('it_company_submenu_menu_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'it_company_submenu_menu_color', array(
		'label'    => __('Submenu Color', 'it-company'),
		'section'  => 'it_company_header_section',
		'settings' => 'it_company_submenu_menu_color',
	)));
	...
	$wp_customize->add_setting( 'it_company_slider_arrow_hide_show',array(
	    'default' => true,   
	    'sanitize_callback' => 'it_company_sanitize_checkbox'
	));
	$wp_customize->add_control( 'it_company_slider_arrow_hide_show',array(
		'label' => esc_html__( 'Show / Hide Slider Arrows','it-company' ),
		'section' => 'it_company_slider_section',
		'type' => 'checkbox',
	));

	 $wp_customize->add_setting('it_company_slider_arrows_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'it_company_slider_arrows_hover_color', array(
		'label'    => __('Slider Arrows hover Color', 'it-company'),
		'section'  => 'it_company_slider_section',
		'settings' => 'it_company_slider_arrows_hover_color',
	)));
	...
	$wp_customize->add_control( 'it_company_slider_button_label', array(
		...
		$wp_customize->add_setting('it_company_slider_btn_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'it_company_slider_btn_color', array(
		'label'    => __('Slider Button Lable Color', 'it-company'),
		'section'  => 'it_company_slider_section',
		'settings' => 'it_company_slider_btn_color',
	)));

	$wp_customize->add_setting('it_company_slider_btn_bg_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'it_company_slider_btn_bg_color', array(
		'label'    => __('Slider Button Bg Color', 'it-company'),
		'section'  => 'it_company_slider_section',
		'settings' => 'it_company_slider_btn_bg_color',
	)));

    $wp_customize->add_setting('it_company_slider_btn_lable_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'it_company_slider_btn_lable_hover_color', array(
		'label'    => __('Slider Button Lable hover Color', 'it-company'),
		'section'  => 'it_company_slider_section',
		'settings' => 'it_company_slider_btn_lable_hover_color',
	)));

	$wp_customize->add_setting('it_company_slider_btn_bg_hover_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'it_company_slider_btn_bg_hover_color', array(
		'label'    => __('Slider Button Bg hover Color', 'it-company'),
		'section'  => 'it_company_slider_section',
		'settings' => 'it_company_slider_btn_bg_hover_color',
	)));
    ...
    $wp_customize->add_setting('it_company_postdate_icon',array(
		'default'	=> 'fas fa-calendar-alt',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new IT_Company_Icon_Selector(
        $wp_customize,'it_company_postdate_icon',array(
		'label'	=> __('Add Post Date Icon','it-company'),
		'transport' => 'refresh',
		'section'	=> 'it_company_theme_layout',
		'setting'	=> 'it_company_postdate_icon',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('it_company_postauthor_icon',array(
		'default'	=> 'fa fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new IT_Company_Icon_Selector(
        $wp_customize,'it_company_postauthor_icon',array(
		'label'	=> __('Add Post Author Icon','it-company'),
		'transport' => 'refresh',
		'section'	=> 'it_company_theme_layout',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('it_company_postcomment_icon',array(
		'default'	=> 'fas fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new IT_Company_Icon_Selector(
        $wp_customize,'it_company_postcomment_icon',array(
		'label'	=> __('Add Post Comments Icon','it-company'),
		'transport' => 'refresh',
		'section'	=> 'it_company_theme_layout',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('it_company_posttime_icon',array(
		'default'	=> 'fas fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new IT_Company_Icon_Selector(
        $wp_customize,'it_company_posttime_icon',array(
		'label'	=> __('Add Post Time Icon','it-company'),
		'transport' => 'refresh',
		'section'	=> 'it_company_theme_layout',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('it_company_singlepost_date_icon',array(
		'default'	=> 'fas fa-calendar-alt',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new IT_Company_Icon_Selector(
        $wp_customize,'it_company_singlepost_date_icon',array(
		'label'	=> __('Add Single Post Date Icon','it-company'),
		'transport' => 'refresh',
		'section'	=> 'it_company_single_post_settings',
		'setting'	=> 'it_company_singlepost_date_icon',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('it_company_singlepost_author_icon',array(
		'default'	=> 'fa fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new IT_Company_Icon_Selector(
        $wp_customize,'it_company_singlepost_author_icon',array(
		'label'	=> __('Add Single Post Author Icon','it-company'),
		'transport' => 'refresh',
		'section'	=> 'it_company_single_post_settings',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('it_company_single_post_comment_icon',array(
		'default'	=> 'fas fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new IT_Company_Icon_Selector(
        $wp_customize,'it_company_single_post_comment_icon',array(
		'label'	=> __('Add Single Post Comments Icon','it-company'),
		'transport' => 'refresh',
		'section'	=> 'it_company_single_post_settings',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('it_company_single_post_time_icon',array(
		'default'	=> 'fas fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new IT_Company_Icon_Selector(
        $wp_customize,'it_company_single_post_time_icon',array(
		'label'	=> __('Add Single Post Time Icon','it-company'),
		'transport' => 'refresh',
		'section'	=> 'it_company_single_post_settings',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('it_company_single_post_category',array(
       'default' => 'true',
       'sanitize_callback'	=> 'it_company_sanitize_checkbox'
    ));
    $wp_customize->add_control('it_company_single_post_category',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Single Post Category','it-company'),
       'section' => 'it_company_single_post_settings'
    ));
    ...
    $wp_customize->add_setting( 'it_company_single_post_img_border_radius', array(
		'default'=> 0,
		'sanitize_callback'	=> 'it_company_sanitize_float',
	) );
	$wp_customize->add_control( 'it_company_single_post_img_border_radius', array(
		'label'       => esc_html__( 'Single Post Image Border Radius','it-company' ),
		'section'     => 'it_company_single_post_settings',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting( 'it_company_single_post_img_box_shadow',array(
		'default' => 0,
		'sanitize_callback'    => 'it_company_sanitize_float',
	));
	$wp_customize->add_control('it_company_single_post_img_box_shadow',array(
		'label' => esc_html__( 'Single Post Image Shadow','it-company' ),
		'section' => 'it_company_single_post_settings',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
    ...
    $wp_customize->add_setting( 'it_company_related_post_excerpt_number',array(
		'default' => 20,
		'sanitize_callback' => 'it_company_sanitize_float'
	));

	$wp_customize->add_control('it_company_related_post_excerpt_number',	array(
		'label' => esc_html__( 'Related Posts Content Limit','it-company' ),
		'section' => 'it_company_single_post_settings',
		'type'    => 'number',
	 	'settings' => 'it_company_related_post_excerpt_number',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
			'step' => 1,
    ...
    $wp_customize->add_setting( 'it_company_preloader_color', array(
  	...
  	$wp_customize->add_setting('it_company_preloader_bg_img',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw',
	));
	$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,'it_company_preloader_bg_img',array(
        'label' => __('Preloader Background Image','it-company'),
        'section' => 'it_company_advance_options'
	)));
	...
	$wp_customize->add_setting( 'it_company_single_page_breadcrumb',array(
		'default' => true,
      	'sanitize_callback'	=> 'it_company_sanitize_checkbox'
    ) );
    $wp_customize->add_control('it_company_single_page_breadcrumb',array(
    	'type' => 'checkbox',
        'label' => __( 'Show / Hide Single Page Breadcrumb','it-company' ),
        'section' => 'it_company_advance_options'
    ));

    $wp_customize->add_setting('it_company_breadcrumb_color', array(
		'default'           => '#fff',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'it_company_breadcrumb_color', array(
		'label'    => __('Breadcrumb Color', 'it-company'),
		'section'  => 'it_company_advance_options',
	)));

	$wp_customize->add_setting('it_company_breadcrumb_background_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'it_company_breadcrumb_background_color', array(
		'label'    => __('Breadcrumb Background Color', 'it-company'),
		'section'  => 'it_company_advance_options',
	)));

	$wp_customize->add_setting('it_company_breadcrumb_hover_color', array(
		'default'           => '#fff',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'it_company_breadcrumb_hover_color', array(
		'label'    => __('Breadcrumb Hover Color', 'it-company'),
		'section'  => 'it_company_advance_options',
	)));

	$wp_customize->add_setting('it_company_breadcrumb_hover_bg_color', array(
		'default'           => '#000 ',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'it_company_breadcrumb_hover_bg_color', array(
		'label'    => __('Breadcrumb Hover Background Color', 'it-company'),
		'section'  => 'it_company_advance_options',
	)));
	...
	$wp_customize->add_setting( 'it_company_toggle_button_bg_color_settings', array(
	    'default' => '',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'it_company_toggle_button_bg_color_settings', array(
  		'label' => __('Toggle Button Bg Color', 'it-company'),
	    'section' => 'it_company_responsive_options',
	    'settings' => 'it_company_toggle_button_bg_color_settings',
  	)));
	...
	$wp_customize->add_setting( 'it_company_sidebar_hide_show',array(
      'default' => true,
      'sanitize_callback'	=> 'it_company_sanitize_checkbox'
    ));
    $wp_customize->add_control('it_company_sidebar_hide_show',array(
      'type' => 'checkbox',
      'label' => esc_html__( 'Enable Sidebar','it-company' ),
      'section' => 'it_company_responsive_options'
    ));
    ...
    $wp_customize->add_setting('it_company_shop_page_layout', array(
		'default'           => 'Right Sidebar',
		'sanitize_callback' => 'it_company_sanitize_choices',
	));
	$wp_customize->add_control('it_company_shop_page_layout',array(
		'type'           => 'radio',
		'label'          => __('Shop Page Layout', 'it-company'),
		'section'        => 'it_company_woocommerce',
		'choices'        => array(
			'Left Sidebar'  => __('Left Sidebar', 'it-company'),
			'Right Sidebar' => __('Right Sidebar', 'it-company'),
    ...
    $wp_customize->add_setting('it_company_single_product_page_layout', array(
		'default'           => 'Right Sidebar',
		'sanitize_callback' => 'it_company_sanitize_choices',
	));
	$wp_customize->add_control('it_company_single_product_page_layout',array(
		'type'           => 'radio',
		'label'          => __('Single Product Page Layout', 'it-company'),
		'section'        => 'it_company_woocommerce',
		'choices'        => array(
			'Left Sidebar'  => __('Left Sidebar', 'it-company'),
			'Right Sidebar' => __('Right Sidebar', 'it-company'),
	...
	$wp_customize->add_setting( 'it_company_footer_hide_show',array(
      'default' => 'true',
      'sanitize_callback' => 'it_company_sanitize_checkbox'
    ));
    $wp_customize->add_control('it_company_footer_hide_show',array(
    	'type' => 'checkbox',
      'label' => esc_html__( 'Show / Hide Footer','it-company' ),
      'section' => 'it_company_footer_section'
    ));
    ...
    $wp_customize->add_setting('it_company_footer_widgets_heading',array(
    'default' => 'Left',
    'transport' => 'refresh',
    'sanitize_callback' => 'it_company_sanitize_choices'
	));
	$wp_customize->add_control('it_company_footer_widgets_heading',array(
    'type' => 'select',
    'label' => __('Footer Widget Heading Alignment','it-company'),
    'section' => 'it_company_footer_section',
    'choices' => array(
    	'Left' => __('Left','it-company'),
        'Center' => __('Center','it-company'),
	...
	$wp_customize->add_setting('it_company_footer_widgets_content',array(
    'default' => 'Left',
    'transport' => 'refresh',
    'sanitize_callback' => 'it_company_sanitize_choices'
	));
	$wp_customize->add_control('it_company_footer_widgets_content',array(
    'type' => 'select',
    'label' => __('Footer Widget Content Alignment','it-company'),
    'section' => 'it_company_footer_section',
    'choices' => array(
    	'Left' => __('Left','it-company'),
        'Center' => __('Center','it-company'),
    ...
    $wp_customize->add_setting( 'it_company_copyright_hide_show',array(
      'default' => 'true',
      'sanitize_callback' => 'it_company_sanitize_checkbox'
    ));
    $wp_customize->add_control('it_company_copyright_hide_show',array(
    	'type' => 'checkbox',
      'label' => esc_html__( 'Show / Hide Copyright','it-company' ),
      'section' => 'it_company_footer_section'
    ));
