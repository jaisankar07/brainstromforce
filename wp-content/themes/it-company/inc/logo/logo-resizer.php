...
function it_company_logo_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'it_company_logo_spacing', array(
		'default'              => '',
       'sanitize_callback'	=> 'it_company_sanitize_float'
	) );
	$wp_customize->add_control( 'it_company_logo_spacing', array(
		'label'       => esc_html__( 'Logo Padding','it-company' ),
		'section'     => 'title_tagline',
		'priority'    => 9,
		'type'        => 'number',
		'settings'    => 'it_company_logo_spacing',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 0,
			'max'              => 50,
	...
	$wp_customize->add_setting( 'it_company_logo_margin', array(
		'default'              => '',
       'sanitize_callback'	=> 'it_company_sanitize_float'
	) );
	$wp_customize->add_control( 'it_company_logo_margin', array(
		'label'       => esc_html__( 'Logo Margin','it-company' ),
		'section'     => 'title_tagline',
		'priority'    => 9,
		'type'        => 'number',
		'settings'    => 'it_company_logo_margin',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 0,
			'max'              => 50,
	...
	$wp_customize->add_setting('it_company_site_title_font_size',array(
		'default'=> '25',
		'sanitize_callback'	=> 'it_company_sanitize_float'
	));
	$wp_customize->add_control('it_company_site_title_font_size',array(
		'label'	=> __('Site Title Font Size','it-company'),
		'input_attrs' => array(
         'step' => 1,
			'min' => 0,
			'max' => 50,
	...
	$wp_customize->add_setting('it_company_site_tagline_font_size',array(
		'default'=> '12',
		'sanitize_callback'	=> 'it_company_sanitize_float'
	));
	$wp_customize->add_control('it_company_site_tagline_font_size',array(
		'label'	=> __('Site Tagline Font Size','it-company'),
		'input_attrs' => array(
         'step' => 1,
			'min' => 0,
			'max' => 50,
	...
	// site title color
   $wp_customize->add_setting('it_company_site_title_text_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'it_company_site_title_text_color', array(
		'label'    => __('Change Site Title Text Color', 'it-company'),
		'section'  => 'title_tagline',
		'settings' => 'it_company_site_title_text_color',
	)));

	// site tagline font color
	$wp_customize->add_setting('it_company_site_tagline_text_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'it_company_site_tagline_text_color', array(
		'label'    => __('Change Site Tagline Text Color', 'it-company'),
		'section'  => 'title_tagline',
		'settings' => 'it_company_site_tagline_text_color',
	)));
}
...
function it_company_customize_controls_js() {
	wp_enqueue_script( 'it-company-customizer-controls', esc_url(get_template_directory_uri()) . '/inc/logo/js/customize-controls.js', array( 'jquery', 'customize-preview' ), '201709071000', true );
}
