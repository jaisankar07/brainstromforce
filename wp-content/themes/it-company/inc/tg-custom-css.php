<?php
	...
	if($it_company_first_theme_color != false){
		$it_company_custom_css .=' #footer input[type="submit"], #sidebar .tagcloud a:hover, input[type="submit"], .nav-menu ul ul a, h1.page-title, h1.search-title, .more-btn a, .post-info, .blogbtn a, .inner, .footerinner .tagcloud a:hover, .woocommerce span.onsale, .woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button,.woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, nav.woocommerce-MyAccount-navigation ul li, #sidebar input[type="submit"], .pagination .current, span.meta-nav,  .tags a:hover,#comments a.comment-reply-link, #comments input[type="submit"].submit, a.button,.back-to-top, #slider .carousel-indicators .active, .woocommerce-product-search button, .navigation .nav-previous a, .navigation .nav-next a, .woocommerce .widget_price_filter .ui-slider-horizontal .ui-slider-range, .woocommerce .widget_price_filter .ui-slider .ui-slider-handle, #footer .search-form input[type="submit"], #sidebar .search-form input[type="submit"], .woocommerce nav.woocommerce-pagination ul li a:hover, .woocommerce nav.woocommerce-pagination ul li span.current, .post-categories li a{';
    ...
    if($it_company_slider_layout == 'Left Align'){
		...
		$it_company_custom_css .='left:17%; right:30%;';
		$it_company_custom_css .='}';
		...
		$it_company_custom_css .='}';
		$it_company_custom_css .='#slider .carousel-caption{';
		$it_company_custom_css .='left:30%; right:18%;';
		$it_company_custom_css .='}';
	}

	// Slider Arrows hover color
	$it_company_slider_arrows_hover_color = get_theme_mod('it_company_slider_arrows_hover_color');
	$it_company_custom_css .='#slider .carousel-control-prev-icon:hover,#slider .carousel-control-next-icon:hover{';
			$it_company_custom_css .='background-color: '.esc_attr($it_company_slider_arrows_hover_color).' !important;';
	$it_company_custom_css .='}';

	/*------ slider arrow hide show---------*/
	$it_company_slider_arrow_hide_show = get_theme_mod('it_company_slider_arrow_hide_show',true);
	if($it_company_slider_arrow_hide_show == false){
		$it_company_custom_css .='#slider .carousel-control-prev-icon, #slider .carousel-control-next-icon{';
	...
	$it_company_preloader_bg_img = get_theme_mod('it_company_preloader_bg_img');
	if($it_company_preloader_bg_img != false){
		$it_company_custom_css .=' #overlayer, .preloader{';
			$it_company_custom_css .='background: url('.esc_attr($it_company_preloader_bg_img).');-webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;';
		$it_company_custom_css .='}';
	}
	...
	$it_company_toggle_button_bg_color_settings = get_theme_mod('it_company_toggle_button_bg_color_settings');
	$it_company_custom_css .='.toggle-menu {';
	$it_company_custom_css .='background-color: '.esc_attr($it_company_toggle_button_bg_color_settings).';';
	$it_company_custom_css .='} ';
	...
	$it_company_resp_sidebar = get_theme_mod( 'it_company_sidebar_hide_show',true);
    if($it_company_resp_sidebar == true){
    	$it_company_custom_css .='@media screen and (max-width:575px) {';
		$it_company_custom_css .='#sidebar{';
			$it_company_custom_css .='display:block;';
		$it_company_custom_css .='} }';
	}else if($it_company_resp_sidebar == false){
		$it_company_custom_css .='@media screen and (max-width:575px) {';
		$it_company_custom_css .='#sidebar{';
			$it_company_custom_css .='display:none;';
		$it_company_custom_css .='} }';
	...
	$it_company_footer_widgets_heading = get_theme_mod( 'it_company_footer_widgets_heading','Left');
    if($it_company_footer_widgets_heading == 'Left'){
		$it_company_custom_css .='#footer h3{';
		$it_company_custom_css .='text-align: left;';
		$it_company_custom_css .='}';
	}else if($it_company_footer_widgets_heading == 'Center'){
		$it_company_custom_css .='#footer h3{';
			$it_company_custom_css .='text-align: center;';
		$it_company_custom_css .='}';
	}else if($it_company_footer_widgets_heading == 'Right'){
		$it_company_custom_css .='#footer h3{';
			$it_company_custom_css .='text-align: right;';
		$it_company_custom_css .='}';
	}

	$it_company_footer_widgets_content = get_theme_mod( 'it_company_footer_widgets_content','Left');
    if($it_company_footer_widgets_content == 'Left'){
		$it_company_custom_css .='#footer .widget ul{';
		$it_company_custom_css .='text-align: left;';
		$it_company_custom_css .='}';
	}else if($it_company_footer_widgets_content == 'Center'){
		$it_company_custom_css .='#footer .widget ul{';
			$it_company_custom_css .='text-align: center;';
		$it_company_custom_css .='}';
	}else if($it_company_footer_widgets_content == 'Right'){
		$it_company_custom_css .='#footer .widget ul{';
			$it_company_custom_css .='text-align: right;';
		$it_company_custom_css .='}';
	}
	...
	// Slider Button color
	$it_company_slider_btn_color = get_theme_mod('it_company_slider_btn_color','#fff');
	$it_company_custom_css .='.more-btn a{';
			$it_company_custom_css .='color: '.esc_attr($it_company_slider_btn_color).' !important;';
	$it_company_custom_css .='}';

	// Slider button bg color
	$it_company_slider_btn_bg_color = get_theme_mod('it_company_slider_btn_bg_color',);
	$it_company_custom_css .='.more-btn a{';
			$it_company_custom_css .='background: '.esc_attr($it_company_slider_btn_bg_color).' !important;';
	$it_company_custom_css .='}';

	// Slider button lable hover color
	$it_company_slider_btn_lable_hover_color = get_theme_mod('it_company_slider_btn_lable_hover_color',);
	$it_company_custom_css .='.more-btn a:hover{';
			$it_company_custom_css .='color: '.esc_attr($it_company_slider_btn_lable_hover_color).' !important;';
	$it_company_custom_css .='}';

	// Slider button bg hover color
	$it_company_slider_btn_bg_hover_color = get_theme_mod('it_company_slider_btn_bg_hover_color',);
	$it_company_custom_css .='.more-btn a:hover{';
			$it_company_custom_css .='background: '.esc_attr($it_company_slider_btn_bg_hover_color).' !important;';
	$it_company_custom_css .='}';
	...
	// site logo padding 
	$it_company_logo_spacing = get_theme_mod('it_company_logo_spacing', '');
	$it_company_custom_css .='.logo{';
	$it_company_custom_css .='padding: '.esc_attr($it_company_logo_spacing).'px !important;';
	$it_company_custom_css .='}';

	// site title color
	$it_company_site_title_text_color = get_theme_mod('it_company_site_title_text_color');
	$it_company_custom_css .='.logo h1 a,.logo p.site-title a{';
		$it_company_custom_css .='color: '.esc_attr($it_company_site_title_text_color).' !important;';
	$it_company_custom_css .='}';

	// site tagline color
	$it_company_site_tagline_text_color = get_theme_mod('it_company_site_tagline_text_color');
	$it_company_custom_css .='.logo p.site-description,.logo p{';
		$it_company_custom_css .='color: '.esc_attr($it_company_site_tagline_text_color).' !important;';
	$it_company_custom_css .='}';

	// menu padding
	$it_company_menu_padding = get_theme_mod('it_company_menu_padding',20);
	$it_company_custom_css .='.nav-menu ul li a, .sf-arrows ul .sf-with-ul, .sf-arrows .sf-with-ul{';
		$it_company_custom_css .='padding: '.esc_attr($it_company_menu_padding).'px;';
	$it_company_custom_css .='}';

	// site logo margin 
	$it_company_logo_margin = get_theme_mod('it_company_logo_margin', '');
	$it_company_custom_css .='.logo{';
	$it_company_custom_css .='margin: '.esc_attr($it_company_logo_margin).'px;';
	$it_company_custom_css .='}';

	// menu color
	$it_company_menu_color = get_theme_mod('it_company_menu_color');

	$it_company_custom_css .='.nav-menu a,.nav-menu .current_page_item > a, .nav-menu .current-menu-item > a, .nav-menu .current_page_ancestor > a{';
			$it_company_custom_css .='color: '.esc_attr($it_company_menu_color).' !important;';
	$it_company_custom_css .='}';

	// menu hover color
	$it_company_menu_hover_color = get_theme_mod('it_company_menu_hover_color');
	$it_company_custom_css .='.nav-menu a:hover, .nav-menu ul li a:hover, .nav-menu ul.sub-menu a:hover, .nav-menu ul.sub-menu li a:hover{';
			$it_company_custom_css .='color: '.esc_attr($it_company_menu_hover_color).' !important;';
	$it_company_custom_css .='}';

	// Submenu color
	$it_company_submenu_menu_color = get_theme_mod('it_company_submenu_menu_color');
	$it_company_custom_css .='.nav-menu ul.sub-menu a, .nav-menu ul.sub-menu li a{';
			$it_company_custom_css .='color: '.esc_attr($it_company_submenu_menu_color).' !important;';
	$it_company_custom_css .='}';

	// Breadcrumb color option
	$it_company_breadcrumb_color = get_theme_mod('it_company_breadcrumb_color');
	$it_company_custom_css .='.bradcrumbs a,.bradcrumbs span{';
		$it_company_custom_css .='color: '.esc_attr($it_company_breadcrumb_color).'!important;';
	$it_company_custom_css .='}';

	// Breadcrumb bg color option
	$it_company_breadcrumb_background_color = get_theme_mod('it_company_breadcrumb_background_color');
	$it_company_custom_css .='.bradcrumbs a,.bradcrumbs span{';
		$it_company_custom_css .='background-color: '.esc_attr($it_company_breadcrumb_background_color).'!important;';
	$it_company_custom_css .='}';

	// Breadcrumb hover color option
	$it_company_breadcrumb_hover_color = get_theme_mod('it_company_breadcrumb_hover_color');
	$it_company_custom_css .='.bradcrumbs a:hover{';
		$it_company_custom_css .='color: '.esc_attr($it_company_breadcrumb_hover_color).'!important;';
	$it_company_custom_css .='}';

	// Breadcrumb hover bg color option
	$it_company_breadcrumb_hover_bg_color = get_theme_mod('it_company_breadcrumb_hover_bg_color');
	$it_company_custom_css .='.bradcrumbs a:hover{';
		$it_company_custom_css .='background-color: '.esc_attr($it_company_breadcrumb_hover_bg_color).'!important;';
	$it_company_custom_css .='}';

	// Single post image border radious
	$it_company_single_post_img_border_radius = get_theme_mod('it_company_single_post_img_border_radius', 0);
	$it_company_custom_css .='.feature-box img{';
		$it_company_custom_css .='border-radius: '.esc_attr($it_company_single_post_img_border_radius).'px;';
	$it_company_custom_css .='}';

	// Single post image box shadow
	$it_company_single_post_img_box_shadow = get_theme_mod('it_company_single_post_img_box_shadow',0);
	$it_company_custom_css .='.feature-box img{';
		$it_company_custom_css .='box-shadow: '.esc_attr($it_company_single_post_img_box_shadow).'px '.esc_attr($it_company_single_post_img_box_shadow).'px '.esc_attr($it_company_single_post_img_box_shadow).'px #ccc;';
	$it_company_custom_css .='}';
